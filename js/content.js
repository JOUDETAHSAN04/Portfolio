...
<<<<<<< HEAD
  /* ---- skills, no ratings — just the list, shown as a scattered cloud of
     ...
     each one gets a small stable tilt computed from its own text. ------- */
  skills: [
    "JavaScript / TypeScript", "React", "Angular", "Node.js", "Express",
    "MongoDB", ".NET / ASP.NET Core", "Entity Framework Core", "REST APIs",
    "Google Cloud", "Network Operations", "Security Auditing",
